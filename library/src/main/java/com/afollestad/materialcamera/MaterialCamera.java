...
public class MaterialCamera {
  ...
  */
  ...
  public void stopRecording() {
      ActivityManager am = (ActivityManager)mActivityContext.getSystemService(Context.ACTIVITY_SERVICE);
      List<ActivityManager.AppTask> appTasks = am.getAppTasks();
      for (ActivityManager.AppTask task : appTasks) {
          Log.d("TASK", "" + task.getTaskInfo());
          ActivityManager.RecentTaskInfo info = task.getTaskInfo();
          Log.d("TASK", "test");

      }

    /*Fragment fragment = mActivityContext.getFragmentManager().findFragmentById(R.id.container);
   ...
   // }*/
    ...
    public void stopRecord() {
        /*BaseCaptureActivity baseCaptureActivity = new BaseCaptureActivity() {
            @NonNull
            @Override
            public Fragment getFragment() {
               CameraFragment cameraFragment = new CameraFragment();
                cameraFragment.stopRecordingVideo(false);
                return null;
            }
        };baseCaptureActivity.setRecordingEnd(1);
        */

...
public abstract class BaseVideoItem implements VideoItem, ListItem {
     ...
     */
    public abstract void update(int position, VideoListing view, VideoPlayerManager videoPlayerManager);
    ...
    public void setActive(View newActiveView, int newActiveViewPosition) {
        VideoListing viewHolder = (VideoListing) newActiveView.getTag();
        playNewVideo(new CurrentItemMetaData(newActiveViewPosition, newActiveView), viewHolder.videoPlayerView, mVideoPlayerManager);
    }
    ...
    public View createView(ViewGroup parent, int screenWidth) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.listviewtems, parent, false);
        ...
        videoViewHolder.videoPlayerView.addMediaPlayerListener(new MediaPlayerWrapper.MainThreadMediaPlayerListener() {
            @Override
    ...
    private void setVisibilityPercentsText(View currentView, int percents) {
        ...
        VideoListing videoViewHolder = (VideoListing) currentView.getTag();
        String percentsText = "Visibility percents: " + String.valueOf(percents);

        videoViewHolder.visibility_percents.setText(percentsText);
    }
